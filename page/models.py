...
# #     objects = SoftDeleteManager()  # Override the default manager
...
# #     class Meta:
# #         abstract = False  # Ensure this model is not abstract

# # class StudentHistory(models.Model):  <<<<<<<<3>>>>>>
...
# #             deleted_by='Admin'  # Replace with the actual user
# #         )
